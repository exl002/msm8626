...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.wcnss/2.1.c16/core/bsp/build/scripts/swe_builder.py#1 $
#
...
def swe_builder(target, source, env):
    ...
    tracer_event_ids_h.write(header_tags)
    ...
    if tracer_event_tbl != "":
        ...
        tracer_event_tbl_h.write(header_tags)
